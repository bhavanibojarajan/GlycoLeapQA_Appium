...
public class IOS_Notification_Glucose_Repository implements Notification_Weight_Repository{
    ...
    public IOSElement glucosevalueunits;
    ...
    public void Check_units_Notification(String units)
        {
            ...
            assertThat(glucosevalueunits.getText().toLowerCase(), containsString(units));

            Log.info("The Units displayed for the current weight same as in the settings "+glucosevalueunits.getText());
